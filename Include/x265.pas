...
type
  Px265_encoder = ^Tx265_encoder;
	Tx265_encoder = record
...
type
  PPx265_nal = ^Px265_nal;
  Px265_nal = ^Tx265_nal;
  Tx265_nal = record
    type_     : System.Cardinal;        (* NalUnitType *)
    sizeBytes : System.Cardinal;   (* size in bytes *)
    payload   : System.PByte;
  end;


(* Stores all analysis data for a single frame *)
  Px265_analysis_data = ^Tx265_analysis_data;
  Tx265_analysis_data = record
    satdCost        : System.Int64;
    frameRecordSize : System.Cardinal;
    poc             : System.Cardinal;
    sliceType       : System.Cardinal;
    numCUsInFrame   : System.Cardinal;
    numPartitions   : System.Cardinal;
    bScenecut       : System.Integer;
    interData       : System.Pointer;
    intraData       : System.Pointer;
  end;

(* cu statistics *)
  Px265_cu_stats = ^Tx265_cu_stats;
  Tx265_cu_stats = record
    percentSkipCu             : array[0..3] of System.Double;                // Percentage of skip cu in all depths
    percentMergeCu            : array[0..3] of System.Double;               // Percentage of merge cu in all depths
    percentIntraDistribution  : array[0..3, 0..2] of System.Double;  // Percentage of DC, Planar, Angular intra modes in all depths
    percentInterDistribution  : array[0..3, 0..2] of System.Double;  // Percentage of 2Nx2N inter, rect and amp in all depths
    percentIntraNxN           : System.Double;                 // Percentage of 4x4 cu
    (* All the above values will add up to 100%. *)
  end;

(* Frame level statistics *)
  Px265_frame_stats = ^Tx265_frame_stats;
  Tx265_frame_stats = record
    qp                  : System.Double;
    rateFactor          : System.Double;
    psnrY               : System.Double;
    psnrU               : System.Double;
    psnrV               : System.Double;
    psnr                : System.Double;
    ssim                : System.Double;
    decideWaitTime      : System.Double;
    row0WaitTime        : System.Double;
    wallTime            : System.Double;
    refWaitWallTime     : System.Double;
    totalCTUTime        : System.Double;
    stallTime           : System.Double;
    avgWPP              : System.Double;
    avgLumaDistortion   : System.Double;
    avgChromaDistortion : System.Double;
    avgPsyEnergy        : System.Double;
    avgResEnergy        : System.Double;
    avgLumaLevel        : System.Double;
    bits                : System.UInt64;
    encoderOrder        : System.Integer;
    poc                 : System.Integer;
    countRowBlocks      : System.Integer;
    list0POC            : array[0..15] of System.Integer;
    list1POC            : array[0..15] of System.Integer;
    maxLumaLevel        : System.Word;
    sliceType           : System.AnsiChar;
    bScenecut           : System.Integer;
    frameLatency        : System.Integer;
    cuStats             : Tx265_cu_stats;
  end;
 ...
 * Payloads are written in the order of input *)
  ...
  Px265_sei_payload = ^Tx265_sei_payload;
  Tx265_sei_payload = record
    payloadSize   : System.Integer;
    payloadType   : TSEIPayloadType;
    payload       : System.PByte;
  end;

  Px265_sei = ^Tx265_sei;
  Tx265_sei = record
    numPayloads   : System.Integer;
    payloads      : Px265_sei_payload;
  end;


(* Used to pass pictures into the encoder, and to get picture data back out of
 * the encoder.  The input and output semantics are different *)
  Px265_picture = ^Tx265_picture;
  Tx265_picture = record
     ...
     * this data structure *)
    analysisData: Tx265_analysis_data;
    ...
    quantOffsets: System.PSingle;

    (* Frame level statistics *)
    frameData: Tx265_frame_stats;
    ...
    rcData: System.Pointer;

    framesize: System.UInt64;
...
(* x86 *)
const
  X265_CPU_CMOV            = $0000001;
  X265_CPU_MMX             = $0000002;
  X265_CPU_MMX2            = $0000004;  (* MMX2 aka MMXEXT aka ISSE *)
  X265_CPU_MMXEXT          = X265_CPU_MMX2;
  X265_CPU_SSE             = $0000008;
  X265_CPU_SSE2            = $0000010;
  X265_CPU_SSE3            = $0000020;
  X265_CPU_SSSE3           = $0000040;
  X265_CPU_SSE4            = $0000080;  (* SSE4.1 *)
  X265_CPU_SSE42           = $0000100;  (* SSE4.2 *)
  X265_CPU_LZCNT           = $0000200;  (* Phenom support for "leading zero count" instruction. *)
  X265_CPU_AVX             = $0000400;  (* AVX support: requires OS support even if YMM registers aren't used. *)
  X265_CPU_XOP             = $0000800;  (* AMD XOP *)
  X265_CPU_FMA4            = $0001000;  (* AMD FMA4 *)
  X265_CPU_AVX2            = $0002000;  (* AVX2 *)
  X265_CPU_FMA3            = $0004000;  (* Intel FMA3 *)
  X265_CPU_BMI1            = $0008000;  (* BMI1 *)
  X265_CPU_BMI2            = $0010000;  (* BMI2 *)
(* x86 modifiers *)
  X265_CPU_CACHELINE_32    = $0020000;  (* avoid memory loads that span the border between two cachelines *)
  X265_CPU_CACHELINE_64    = $0040000;  (* 32/64 is the size of a cacheline in bytes *)
  X265_CPU_SSE2_IS_SLOW    = $0080000;  (* avoid most SSE2 functions on Athlon64 *)
  X265_CPU_SSE2_IS_FAST    = $0100000;  (* a few functions are only faster on Core2 and Phenom *)
  X265_CPU_SLOW_SHUFFLE    = $0200000;  (* The Conroe has a slow shuffle unit (relative to overall SSE performance) *)
  X265_CPU_STACK_MOD4      = $0400000;  (* if stack is only mod4 and not mod16 *)
  X265_CPU_SLOW_CTZ        = $0800000;  (* BSR/BSF x86 instructions are really slow on some CPUs *)
  X265_CPU_SLOW_ATOM       = $1000000;  (* The Atom is terrible: slow SSE unaligned loads, slow
                                             * SIMD multiplies, slow SIMD variable shifts, slow pshufb,
                                             * cacheline split penalties -- gather everything here that
                                             * isn't shared by other CPUs to avoid making half a dozen
                                             * new SLOW flags. *)
  X265_CPU_SLOW_PSHUFB     = $2000000;  (* such as on the Intel Atom *)
  X265_CPU_SLOW_PALIGNR    = $4000000;  (* such as on the AMD Bobcat *)

(* ARM *)
  X265_CPU_ARMV6           = $0000001;
  X265_CPU_NEON            = $0000002;  (* ARM NEON *)
  X265_CPU_FAST_NEON_MRC   = $0000004;  (* Transfer from NEON to ARM register is fast (Cortex-A9) *)

(* IBM Power8 *)
  X265_CPU_ALTIVEC         = $0000001;

  X265_MAX_SUBPEL_LEVEL    = 7;
...
(* Log level *)
  ...
  X265_B_ADAPT_NONE        = 0;
  X265_B_ADAPT_FAST        = 1;
  X265_B_ADAPT_TRELLIS     = 2;

  X265_REF_LIMIT_DEPTH     = 1;
  X265_REF_LIMIT_CU        = 2;

  X265_TU_LIMIT_BFS        = 1;
  X265_TU_LIMIT_DFS        = 2;
  X265_TU_LIMIT_NEIGH      = 4;

  X265_BFRAME_MAX          = 16;
  X265_MAX_FRAME_THREADS   = 16;

  X265_TYPE_AUTO           = $0000;  (* Let x265 choose the right type *)
  X265_TYPE_IDR            = $0001;
  X265_TYPE_I              = $0002;
  X265_TYPE_P              = $0003;
  X265_TYPE_BREF           = $0004;  (* Non-disposable B-frame *)
  X265_TYPE_B              = $0005;
  //IS_X265_TYPE_I(x) ((x) == X265_TYPE_I || (x) == X265_TYPE_IDR)
  //IS_X265_TYPE_B(x) ((x) == X265_TYPE_B || (x) == X265_TYPE_BREF)

  X265_QP_AUTO                 = 0;

  X265_AQ_NONE                 = 0;
  X265_AQ_VARIANCE             = 1;
  X265_AQ_AUTO_VARIANCE        = 2;
...
(* Supported internal color space types (according to semantics of chroma_format_idc) *)
  X265_CSP_I400           = 0;  (* yuv 4:0:0 planar *)
  X265_CSP_I420           = 1;  (* yuv 4:2:0 planar *)
  X265_CSP_I422           = 2;  (* yuv 4:2:2 planar *)
  X265_CSP_I444           = 3;  (* yuv 4:4:4 planar *)
  X265_CSP_COUNT          = 4;  (* Number of supported internal color spaces *)
 ...
 * be converted to the appropriate planar color spaces at ingest *)
  X265_CSP_NV12           = 4;  (* yuv 4:2:0, with one y plane and one packed u+v *)
  X265_CSP_NV16           = 5;  (* yuv 4:2:2, with one y plane and one packed u+v *)

(* Interleaved color-spaces may eventually be supported as input pictures *)
  X265_CSP_BGR            = 6;  (* packed bgr 24bits   *)
  X265_CSP_BGRA           = 7;  (* packed bgr 32bits   *)
  X265_CSP_RGB            = 8;  (* packed rgb 24bits   *)
  X265_CSP_MAX            = 9;  (* end of list *)

  X265_EXTENDED_SAR       = 255; (* aspect ratio explicitly specified as width:height *)

(* Analysis options *)
  X265_ANALYSIS_OFF  = 0;
  X265_ANALYSIS_SAVE = 1;
  X265_ANALYSIS_LOAD = 2;

type
  Px265_cli_csp = ^Tx265_cli_csp;
  Tx265_cli_csp = record
    planes  : System.Integer;
    width   : array[0..2] of System.Integer;
    height  : array[0..2] of System.Integer;
  end;

const
  x265_cli_csps : array[0..5] of Tx265_cli_csp =
  (
    ( planes: 1; width: ( 0, 0, 0 ); height: ( 0, 0, 0 ) ),     (* i400 *)
    ( planes: 3; width: ( 0, 1, 1 ); height: ( 0, 1, 1 ) ),     (* i420 *)
    ( planes: 3; width: ( 0, 1, 1 ); height: ( 0, 0, 0 ) ),     (* i422 *)
    ( planes: 3; width: ( 0, 0, 0 ); height: ( 0, 0, 0 ) ),     (* i444 *)
    ( planes: 2; width: ( 0, 0, 0 ); height: ( 0, 1, 0 ) ),     (* nv12 *)
    ( planes: 2; width: ( 0, 0, 0 ); height: ( 0, 0, 0 ) )      (* nv16 *)
  );
...
(* slice type statistics *)
  Px265_sliceType_stats = ^Tx265_sliceType_stats;
  Tx265_sliceType_stats = record
    avgQp         : System.Double;
    bitrate       : System.Double;
    psnrY         : System.Double;
    psnrU         : System.Double;
    psnrV         : System.Double;
    ssim          : System.Double;
    numPics       : System.Cardinal;
  end;

(* Output statistics from encoder *)
  Px265_stats= ^Tx265_stats;
  Tx265_stats = record
    globalPsnrY           : System.Double;
    globalPsnrU           : System.Double;
    globalPsnrV           : System.Double;
    globalPsnr            : System.Double;
    globalSsim            : System.Double;
    elapsedEncodeTime     : System.Double;    (* wall time since encoder was opened *)
    elapsedVideoTime      : System.Double;     (* encoded picture count / frame rate *)
    bitrate               : System.Double;              (* accBits / elapsed video time *)
    accBits               : System.UInt64;              (* total bits output thus far *)
    encodedPictureCount   : System.Cardinal;  (* number of output pictures thus far *)
    totalWPFrames         : System.Cardinal;        (* number of uni-directional weighted frames used *)
    statsI                : Tx265_sliceType_stats;                (* statistics of I slice *)
    statsP                : Tx265_sliceType_stats;                (* statistics of P slice *)
    statsB                : Tx265_sliceType_stats;               (* statistics of B slice *)
    maxCLL                : System.Word;               (* maximum content light level *)
    maxFALL               : System.Word;              (* maximum frame average light level *)
  end;

(* String values accepted by x265_param_parse() (and CLI) for various parameters *)
const
  x265_motion_est_names: array[0..5] of PAnsiChar = ('dia', 'hex', 'umh', 'star', 'full', nil);
  x265_source_csp_names: array[0..6] of PAnsiChar = ('i400', 'i420', 'i422', 'i444', 'nv12', 'nv16', nil);
  x265_video_format_names: array[0..6] of PAnsiChar = ('component', 'pal', 'ntsc', 'secam', 'mac', 'undef', nil);
  x265_fullrange_names: array[0..2] of PAnsiChar = ('limited', 'full', nil);
  x265_colorprim_names: array[0..10] of PAnsiChar = ('', 'bt709', 'undef', '', 'bt470m', 'bt470bg', 'smpte170m', 'smpte240m', 'film', 'bt2020', nil);
  x265_transfer_names: array[0..19] of PAnsiChar = ('', 'bt709', 'undef', '', 'bt470m', 'bt470bg', 'smpte170m', 'smpte240m', 'linear', 'log100',
                                                      'log316', 'iec61966-2-4', 'bt1361e', 'iec61966-2-1', 'bt2020-10', 'bt2020-12',
                                                      'smpte-st-2084', 'smpte-st-428', 'arib-std-b67', nil);
  x265_colmatrix_names: array[0..11] of PAnsiChar = ('BR', 'bt709', 'undef', '', 'fcc', 'bt470bg', 'smpte170m', 'smpte240m',
                                                       'YCgCo', 'bt2020nc', 'bt2020c', nil);
  x265_sar_names: array[0..17] of PAnsiChar = ('undef', '1:1', '12:11', '10:11', '16:11', '40:33', '24:11', '20:11',
                                                 '32:11', '80:33', '18:11', '15:11', '64:33', '160:99', '4:3', '3:2', '2:1', nil);
  x265_interlace_names: array[0..3] of PAnsiChar = ('prog', 'tff', 'bff', nil);
  x265_analysis_names: array[0..3] of PAnsiChar = ('off', 'save', 'load', nil);

(* Zones: override ratecontrol for specific sections of the video.
 * If zones overlap, whichever comes later in the list takes precedence. *)
type
  Px265_zone = ^Tx265_zone;
  Tx265_zone = record

    startFrame, endFrame  : System.Integer; (* range of frame numbers *)
    bForceQp              : System.Integer;             (* whether to use qp vs bitrate factor *)
    qp                    : System.Integer;
    bitrateFactor         : System.Single;
  end;
 ...
 * x265_param as an opaque data structure *)
  ...
  Tx265_param = record
    ...
    frameNumThreads: System.Integer;
     ...
     * by default *)
    bEnableWavefront: System.Integer;
    ...
    bDistributeModeAnalysis: System.Integer;
    ...
    internalBitDepth: System.Integer;

    (* Color space of internal pictures, must match color space of input
     * pictures *)
    internalCsp: System.Integer;

    (* Numerator and denominator of frame rate *)
    fpsNum: System.Cardinal;
    fpsDenom: System.Cardinal;
    ...
    decodedPictureHashSEI: System.Integer;
     ...
     * sequence. *)
    bEnableTemporalSubLayers: System.Integer;
     ...
     * disabled *)
    bEnableRectInter: System.Integer;
     ...
     * Default is enabled *)
    bEnableSignHiding: System.Integer;
    ...
    bEnableConstrainedIntra: System.Integer;
    ...
    bEnableStrongIntraSmoothing: System.Integer;
    ...
    maxNumMergeCand: System.Cardinal;
    ...
    bSaoNonDeblocked: System.Integer;
     ...
     * is enabled *)
    bEnableTSkipFast: System.Integer;
    ...
    bIntraInBFrames: System.Integer;
     ...
     * Default disabled *)
    bEnableRdRefine: System.Integer;
    ...
    rcs : record
        ...
        aqStrength : System.Double;

        (* Sets the maximum rate the VBV buffer should be assumed to refill at
         * Default is zero *)
        vbvMaxBitrate : System.Integer;

        (* Sets the size of the VBV buffer in kilobits. Default is zero *)
        vbvBufferSize : System.Integer;
        ...
        qgSize : System.Cardinal;

        (* internally enable if tune grain is set *)
        bEnableGrain : System.Integer;

        (* sets a hard upper limit on QP *)
        qpMax : System.Integer;

        (* sets a hard lower limit on QP *)
        qpMin : System.Integer;
    end;
    ...
    vui : record
         ...
         * is false *)
        bEnableOverscanInfoPresentFlag : System.Integer;
        ...
        bEnableOverscanAppropriateFlag : System.Integer;
        ...
        bEnableVideoFullRangeFlag : System.Integer;
        ...
        bEnableDefaultDisplayWindowFlag : System.Integer;
    ...
    masteringDisplayColorVolume : System.PAnsiChar;
...
function x265_param_alloc(): Px265_param;
  cdecl; external LIB_X265;

(* x265_param_free:
 *  Use x265_param_free() to release storage for an x265_param instance
 *  allocated by x265_param_alloc() *)
procedure x265_param_free(param: Px265_param);
  cdecl; external LIB_X265;

(* x265_param_default:
 *  Initialize an x265_param structure to default values *)
procedure x265_param_default(param: Px265_param);
  cdecl; external LIB_X265;
...
const
  X265_PARAM_BAD_NAME  = -1;
  X265_PARAM_BAD_VALUE = -2;

function x265_param_parse(p: Px265_param; const name: System.PAnsiChar; const value: System.PAnsiChar): System.Integer;
  cdecl; external LIB_X265;

const
  x265_profile_names: array[0..21] of System.PAnsiChar = (
    (* HEVC v1 *)
...
function x265_param_apply_profile(p: Px265_param; const profile: System.PAnsiChar): System.Integer;
  cdecl; external LIB_X265;
...
const
  x265_preset_names: array[0..10] of System.PAnsiChar = ('ultrafast', 'superfast', 'veryfast', 'faster', 'fast', 'medium', 'slow', 'slower', 'veryslow', 'placebo', nil);
...
const
  x265_tune_names: array[0..5] of System.PAnsiChar = ('psnr', 'ssim', 'grain', 'zerolatency', 'fastdecode',  nil);

(*      returns 0 on success, negative on failure (e.g. invalid preset/tune name). *)
function x265_param_default_preset(p: Px265_param; const preset: System.PAnsiChar; const tune: System.PAnsiChar): System.Integer;
  cdecl; external LIB_X265;
...
procedure x265_picture_init(param: Px265_param; pic: Px265_picture);
  cdecl; external LIB_X265;
...
function x265_encoder_open(param: Px265_param): Px265_encoder;
  cdecl; external LIB_X265 name 'x265_encoder_open_'+X265_BUILD_STR;
...
procedure x265_encoder_parameters(encoder: Px265_encoder; param: Px265_param);
  cdecl; external LIB_X265;
...
function x265_encoder_headers(encoder: Px265_encoder; var pp_nal: Px265_nal; var pi_nal: System.Cardinal): System.Integer;
  cdecl; external LIB_X265;
...
function x265_encoder_encode(encoder: Px265_encoder; var pp_nal: Px265_nal; var pi_nal: System.Cardinal; pic_in: Px265_picture; pic_out: Px265_picture): System.Integer;
  cdecl; external LIB_X265;
...
function x265_encoder_reconfig(encoder: Px265_encoder; param: Px265_param): System.Integer;
  cdecl; external LIB_X265;

(* x265_encoder_get_stats:
 *       returns encoder statistics *)
procedure x265_encoder_get_stats(encoder: Px265_encoder; status: Px265_stats; statsSizeBytes: System.Cardinal);
  cdecl; external LIB_X265;

(* x265_encoder_log:
 *       This function is deprecated *)
procedure x265_encoder_log(encoder: Px265_encoder; argc: integer; var argv: System.PAnsiChar);
  cdecl; external LIB_X265;

(* x265_encoder_close:
 *      close an encoder handler *)
procedure x265_encoder_close(encoder: Px265_encoder);
  cdecl; external LIB_X265;
...
function x265_encoder_intra_refresh(encoder: Px265_encoder): System.Integer;
  cdecl; external LIB_X265;

(* x265_cleanup:
 *       release library static allocations, reset configured CTU size *)
procedure x265_cleanup();
  cdecl; external LIB_X265;

const
  X265_MAJOR_VERSION = 1;
...
type
  Px265_api = ^Tx265_api;
  Tx265_api = record
    api_major_version : System.Integer;    (* X265_MAJOR_VERSION *)
    api_build_number : System.Integer;     (* X265_BUILD (soname) *)
    sizeof_param : System.Integer;         (* sizeof(x265_param) *)
    sizeof_picture : System.Integer;       (* sizeof(x265_picture) *)
    sizeof_analysis_data : System.Integer; (* sizeof(x265_analysis_data) *)
    sizeof_zone : System.Integer;          (* sizeof(x265_zone) *)
    sizeof_stats : System.Integer;         (* sizeof(x265_stats) *)

    bit_depth : System.Integer;
    version_str : System.PAnsiChar;
    build_info_str : System.PAnsiChar;

    (* libx265 public API functions, documented above with x265_ prefixes *)
    param_alloc   : function(): Px265_param; cdecl;
    param_free    : procedure(param: Px265_param); cdecl;
    param_default : procedure(param: Px265_param); cdecl;
    param_parse   : function(p: Px265_param; const name: System.PAnsiChar; const value: System.PAnsiChar): System.Integer; cdecl;
    param_apply_profile : function(p: Px265_param; const profile: System.PAnsiChar): System.Integer; cdecl;
    param_default_preset : function(p: Px265_param; const preset: System.PAnsiChar; const tune: System.PAnsiChar): System.Integer; cdecl;
    picture_alloc : function(): Px265_picture; cdecl;
    picture_free  : procedure(pic: Px265_picture); cdecl;
    picture_init  : procedure(param: Px265_param; pic: Px265_picture); cdecl;
    encoder_open  : function(param: Px265_param): Px265_encoder; cdecl;
    encoder_parameters : procedure(encoder: Px265_encoder; param: Px265_param); cdecl;
    encoder_reconfig   : function(encoder: Px265_encoder; param: Px265_param): System.Integer; cdecl;
    encoder_headers    : function(encoder: Px265_encoder; var pp_nal: Px265_nal; var pi_nal: System.Cardinal): System.Integer; cdecl;
    encoder_encode     : function(encoder: Px265_encoder; var pp_nal: Px265_nal; var pi_nal: System.Cardinal; pic_in: Px265_picture; pic_out: Px265_picture): System.Integer; cdecl;
    encoder_get_stats  : procedure(encoder: Px265_encoder; status: Px265_stats; statsSizeBytes: System.Cardinal); cdecl;
    encoder_log        : procedure(encoder: Px265_encoder; argc: integer; var argv: System.PAnsiChar); cdecl;
    encoder_close      : procedure(encoder: Px265_encoder); cdecl;
    cleanup            : procedure(); cdecl;

    sizeof_frame_stats  : System.Integer;   (* sizeof(x265_frame_stats) *)
    encoder_intra_refresh : function(encoder: Px265_encoder): System.Integer; cdecl;
...
function x265_api_get(bitDepth: System.Integer): Px265_api;
  cdecl; external LIB_X265 name 'x265_api_get_'+X265_BUILD_STR;
 ...
 *   compiled with. *)
function x265_api_query(bitDepth: System.Integer; apiVersion: System.Integer; var err: System.Integer): Px265_api;
  cdecl; external LIB_X265;

const
  X265_API_QUERY_ERR_NONE           = 0; (* returned API pointer is non-NULL *)
  X265_API_QUERY_ERR_VER_REFUSED    = 1; (* incompatible version skew        *)
  X265_API_QUERY_ERR_LIB_NOT_FOUND  = 2; (* libx265_main10 not found, for ex *)
  X265_API_QUERY_ERR_FUNC_NOT_FOUND = 3; (* unable to bind x265_api_query    *)
  X265_API_QUERY_ERR_WRONG_BITDEPTH = 4; (* libx265_main10 not 10bit, for ex *)

const x265_api_query_errnames: array[0..4] of PAnsiChar = (
